<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Register.aspx.cs" Inherits="D_HansSs_Villa.Account.Register" %>
                        ...
                        <fieldset class="register">
                            ...
                            <p>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="FullName" 
                                     CssClass="failureNotification" ErrorMessage="Full Name is required." ToolTip="Name is required." 
                            ...
                            <p>
                                ...
                                <asp:RequiredFieldValidator ID="MobileNumberRequired" runat="server" ControlToValidate="MobileNumber" 
                                     CssClass="failureNotification" ErrorMessage="Mobile Number is required." ToolTip="MobileNumber is required." 
                                     ValidationGroup="RegisterUserValidationGroup">*</asp:RequiredFieldValidator>
                            </p>
                            <p>
